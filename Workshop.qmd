...
The workshop is hosted by TU Delft in the Netherlands ([Faculty of Architecture and the Built environment](https://www.tudelft.nl/en/architecture-and-the-built-environment) and [Library](https://www.tudelft.nl/en/library/)) on **9th-13th November 2026**. It will comprise 25-30 participants and funded by the ERC project SEGUE (101039455).

If you would like to be part of this event, please fill in the registration form below.
...
This workshop will be conducted over 5 days. The week switches from an initial focus on getting to know each other and reaching consensus on needs of our community to a final focus on package design and development planning. 

----

**Pre-workshop**, we will invite participants to submit one paper that addresses segregation and causality in an interesting way, and to prepare one concrete contribution to the workshop (whether data, text, or code). This will produce a select library of data, code and literature from which to accelerate the review of our community’s needs during the workship. We will also survey the participants’ experience, questions and interests in advance to include their input in the preparation of the workshop and suggest participants clusters ahead of the workshop. 

---- 

During the workshop, we build each day on the previous one as follows:
...
**Post-workshop**, we will implement the roadmap to complete the package, write its documentation and user manual. Using  project, members of [![](Logo_Rbanism_%20Full.png){fig-align="left" width="50"}](http://rbanism.org/)’s experience, [![](logo.png){fig-align="left" width="50"}](http://erc-segue.nl/)’s funding and the co-organisers’ time and coordination efforts, the community will be brought together virtually at regular intervals, as well as in person for a final conference showcasing the package and its use cases.


## Organisation team and confirmed partipants {#team}

- Clémentine Cottineau-Mugadza, Assistant Professor in urban studies at TU Delft SEGUE, [![](Logo_Rbanism_%20Full.png){fig-align="left" width="10"}](http://rbanism.org/)). [https://clementinecttn.github.io/](https://clementinecttn.github.io/)

- Javier San Millan Tejedor, PhD Candidate in urban studies at TU Delft SEGUE, [![](Logo_Rbanism_%20Full.png){fig-align="left" width="10"}](http://rbanism.org/) [https://javiersanmillan.github.io/](https://javiersanmillan.github.io/)

- Ignacio Urria Yáñez, PhD Candidate in urban studies at TU Delft [![](Logo_Rbanism_%20Full.png){fig-align="left" width="10"}](http://rbanism.org/) [https://www.tudelft.nl/staff/i.a.urriayanez/](https://www.tudelft.nl/staff/i.a.urriayanez/)

- Daniele Cannatella, Assistant Professor in spatial data science at TU Delft [![](Logo_Rbanism_%20Full.png){fig-align="left" width="10"}](http://rbanism.org/) [https://www.tudelft.nl/staff/d.cannatella/](https://www.tudelft.nl/staff/d.cannatella/)

- Claudiu Forgaci, Assistant Professor in urban design at TU Delft [![](Logo_Rbanism_%20Full.png){fig-align="left" width="10"}](http://rbanism.org/) [https://cforgaci.github.io/](https://cforgaci.github.io/)

- Julien Migozzi, Assistant Professor in Development Studies at University of Cambridge, UK [https://jmigozzi.github.io/](https://jmigozzi.github.io/)

- Aurélie Douet, Research engineer (GIS and mapping) at EHESS, France [https://crh.ehess.fr/index.php?9040](https://crh.ehess.fr/index.php?9040)

- Ana Petrovic, Assistant Professor in urban studies at TU Delft [![](Logo_Rbanism_%20Full.png){fig-align="left" width="10"}](http://rbanism.org/) [https://research.tudelft.nl/en/persons/a-petrovi%C4%87/](https://research.tudelft.nl/en/persons/a-petrovi%C4%87/)

- Levi John Wolf, Associate Professor of Spatial Analysis
University of Bristol , UK [https://www.ljwolf.org/](https://www.ljwolf.org/)

- Seong-Yun Hong, Associate Professor at Kyung Hee University, South Korea [https://khu.elsevierpure.com/en/persons/seong-yun-hong/](https://khu.elsevierpure.com/en/persons/seong-yun-hong/)

- Selcan Mutgan, Assistant Professor at the Institute for Analytical Sociology in Linköping University, Sweden [https://www.selcanmutgan.com/](https://www.selcanmutgan.com/)

- Yuliia Kazmina, PhD candidate at the Faculty of Social and Behavioural Sciences, University of Amsterdam (NL) [https://www.uva.nl/en/profile/k/a/y.kazmina/y.kazmina.html](https://www.uva.nl/en/profile/k/a/y.kazmina/y.kazmina.html)

- Julie Vallée, Senior researcher at CNRS, LISST, France [https://lisst.univ-tlse2.fr/home/julie-vallee](https://lisst.univ-tlse2.fr/home/julie-vallee)
...
Although urban segregation is as old as cities [@nightingale2012segregation], its scientific analysis and measurement can be traced back to the XXth century, with the development of the first segregation indices (cf. [@massey1988dimensions] for the first review). Since then, methodological developments, technical jumps and the release of ever more detailed social data at increasingly fine grain have fostered the creation of dozens of new indices, to address the spatial dimension of segregation [@white1983measurement] [@morrill1991], to consider multi-groups [@wong1998measuring], ordinal variables [@reardon2009measures] and to identify the sub-group components driving segregation. In a first review of the segregation index landscape, the organising team identified 30 distinct measures, along with their use case characteristics. 
